...
<!-- contact -->
<section aria-label="map" class="subfooter" id="contact" style="background-image:url(img/bg-contact.jpg)">
        <div class="container">
          <div class="row">
          ...
          <div class="col-md-12">
           <h2 class="devider-heading">Get In Touch</h2>

           <p class="content-max-1 text-center">
           Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolores ptio neque obcaecati! Incidunt temporibus blanditiis eveniet co
           </p>
          ...
          <div class="no-gutter">
            ...
            <div class="col-md-6">
              <div class="box p-60">
                ...
                <p>
                Lorem sit amet, consectetur adipiscing elit nam lobortis eget nibh
                </p>
